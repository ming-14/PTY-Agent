...
//   ProcessExitNormal  ← JOB_OBJECT_MSG_EXIT_PROCESS 且退出码 == 0（Phase 8）
//   ProcessExitAbnormal← JOB_OBJECT_MSG_EXIT_PROCESS 且退出码 != 0（Phase 8）
//   ActiveProcessEmpty ← JOB_OBJECT_MSG_ACTIVE_PROCESS_ZERO
//   NewProcess         ← JOB_OBJECT_MSG_NEW_PROCESS（Phase 8 起携带进程路径）
