...
//      —— 路线实测定案：SetFileInformationByHandle(FileIntegrityInfo) 非管理员
//      gle=5 固定失败（setil_probe.py）；SetNamedSecurityInfo 零特权 rc=0
//      （label_probe.py / verify_low_flow.py），无回退分支
