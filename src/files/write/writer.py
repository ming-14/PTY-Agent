...
3. generate_diff（供权限与日志，不进 CLI 响应）
...
from src.files.errors import FileToolError, FileReadRequiredError, FilePermissionDeniedError
from src.files.history import FileHistoryStore
from src.files.permission import PermissionPolicy
from src.files.state import FileRecordStore, get_default_store
