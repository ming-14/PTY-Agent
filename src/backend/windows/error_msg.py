...
# STILL_ACTIVE 的单一权威来源在 backend/errors.py（跨平台常量）；
# 此处转出是为兼容本模块旧调用方的 `from .error_msg import STILL_ACTIVE`。
from ..errors import STILL_ACTIVE  # noqa: E402,F401  (re-export)
